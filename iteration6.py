...
features = ['Total Incidents', 'Low', 'Medium (SAP) - 16 Hrs', 'Low (SAP) - 40 Hrs', 'Critical', 'Medium', 'High', 'High (SAP) - 6 Hrs', 'Very High (SAP) - 2 Hrs']
...
def preprocess_data(data):
    ...
    summary_df = pd.DataFrame(columns=['Site', 'Creation Date', 'Total  Incidents', 'Low', 'Medium (SAP) - 16 Hrs', 'No Inputs', 'Low (SAP) - 40 Hrs', 'Critical', 'Medium', 'High', 'High (SAP) - 6 Hrs', 'Very High (SAP) - 2 Hrs'])
...
def plot_bar_chart(location_data, location):
    ...
    fig = px.bar(category_counts, x='Category', y='Count', title=f'Incident Category Distribution for {location}')
...
#         # Exclude 'No Input' from Priority
#         winsorized_time_taken_priority = winsorized_time_taken_priority[winsorized_time_taken_priority.index != 'No Input']

#         # Plot by Priority
#         fig_priority = px.bar( winsorized_time_taken_priority),
